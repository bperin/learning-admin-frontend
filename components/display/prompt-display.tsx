...
export default function PromptDisplay({ content, title, version }: PromptDisplayProps) {
    ...
    return (
        <div className="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden">
            ...
            {/* Code Block */}
            <pre className="p-4 overflow-x-auto text-sm text-gray-300 font-mono bg-gray-950">
                <code>{content}</code>
            </pre>
        </div>
    );
