...
export default function GenerationSchemas() {
    ...
    return (
        <div>
            <div className="mb-6">
                <p className="text-gray-400 text-sm mb-4">Generation schemas define how content is generated. They are immutable - create new versions or activate previous ones.</p>
            ...
            {schemas.length === 0 ? (
                <div className="bg-gray-900 rounded-lg p-8 text-center border border-gray-700">
                    <p className="text-gray-400">No generation schemas found</p>
                </div>
            ) : (
